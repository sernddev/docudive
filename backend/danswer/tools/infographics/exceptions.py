class DataframeGenerationException(Exception):
    def __init__(self, base_exception, message="A custom exception occurred while generating dataframe"):
...
class LLMResponseParsingException(Exception):
    def __init__(self, base_exception, message="A custom LLM response parsing exception occurred"):
        self.message = message
        self.base_exception = base_exception
        super().__init__(self.message, self.base_exception)
