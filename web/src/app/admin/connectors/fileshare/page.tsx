...
import {ConnectorIndexingStatus, FileConfig, FileShareConfig} from "@/lib/types";
...
const Main = () => {
  ...
  const fileIndexingStatuses: ConnectorIndexingStatus<FileShareConfig, {}>[] =
  ...
  return (
    <div>
      ...
      <Text className="mb-2">
        Specify directory path below, click the <b>Upload</b> button, and the contents of
        these files in the given directory path will be searchable via Spectra! Currently supported file
            ...
            <Formik
              ...
              validationSchema={Yup.object().shape({
                name: Yup.string().required(
                  "Please enter a descriptive name for the fileshare"
                ),
              ...
              onSubmit={async (values, formikHelpers) => {
                const uploadCreateAndTriggerConnector = async () => {
                  ...
                  const folderPath = selectedFilepath as string
                  const [connectorErrorMsg, connector] =
                    await createConnector<FileShareConfig>({
                      name: "FileShareConnector-" + Date.now(),
                      source: "file",
                  ...
                  setPopup({
                    type: "success",
                    message: "Successfully added folder path!",
                  });
                };
      ...
      {fileIndexingStatuses.length > 0 && (
        <div>
          <Divider />
          <h2 className="font-bold text-xl mb-2">Folder Paths</h2>
          <SingleUseConnectorsTable<FileShareConfig, {}>
            ...
            specialColumns={[
              {
                ...
                getValue: (ccPairStatus) =>
                  ccPairStatus.connector.connector_specific_config.folder_Path
              },
            ]}
            onUpdate={() =>
              mutate("/api/manage/admin/connector/indexing-status")
...
export default function File() {
  return (
    <div className="mx-auto container">
      ...
      <AdminPageTitle icon={<FileIcon size={32} />} title="FileShare" />
